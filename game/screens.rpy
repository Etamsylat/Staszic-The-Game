...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Szybkie ładowanie") action QuickLoad()
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("Brak zapisu")):
            ...
            vbox:
                ...
                if config.has_sync:
                    if CurrentScreenName() == "save":
                        textbutton _("Synchronizacja Upload"):
                            action UploadSync()
                            xalign 0.5
                    else:
                        textbutton _("Synchronizacja Download"):
                            action DownloadSync()
                            xalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("W oknie") action Preference("display", "window")
                        textbutton _("Pełny ekran") action Preference("display", "fullscreen")

                vbox:
                    style_prefix "check"
                    label _("Pomijanie")
                    textbutton _("Niezobaczone dialogi") action Preference("skip", "toggle")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Auto-przyspieszanie czasu")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Przesuwa dialog i aktywuje interfejs.")

    hbox:
        label _("Spacja")
        text _("Przesuwa dialog bez wybierania opcji.")
    ...
    hbox:
        label _("Escape")
        text _("Otwiera menu gry.")

    hbox:
        label _("Ctrl")
        text _("Pomija dialog po przytrzymaniu.")
    ...
    hbox:
        label _("Page Down")
        text _("Przewija do kolejnego dialogu.")
    ...
    hbox:
        label "S"
        text _("Robi zrzut ekranu.")

    hbox:
        label "V"
        text _("Przełącza asystujące {a=https://www.renpy.org/l/voicing}samodzielne czytanie{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Lewy przycisk myszy")
        text _("Przesuwa dialog i aktywuje interfejs.")

    hbox:
        label _("Środkowy przycisk myszy")
        text _("Ukrywa interfejs użytkownika.")

    hbox:
        label _("Prawy przycisk myszy")
        text _("Otwiera menu gry.")

    hbox:
        label _("Rolka myszy w górę")
        text _("Powrót do wcześniejszego dialogu.")

    hbox:
        label _("Rolka myszy w dół")
        text _("Przewija do kolejnego dialogu.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Lewy spust\nLewy przycisk ramienia")
        text _("Powrót do wcześniejszego dialogu.")

    hbox:
        label _("Prawy przycisk ramienia")
        text _("Przewija do kolejnego dialogu.")

    hbox:
        label _("D-Pad, Joysticki")
        text _("Nawigacja po interfejsie.")

    hbox:
        label _("Start, Przewodnik, Przycisk B/Prawy")
        text _("Otwiera menu gry.")

    hbox:
        label _("Przycisk Y/Górny")
        text _("Ukrywa interfejs użytkownika.")


    textbutton _("Kalibruj") action GamepadCalibrate()
